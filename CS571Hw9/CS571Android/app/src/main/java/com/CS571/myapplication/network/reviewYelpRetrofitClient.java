...
public class reviewYelpRetrofitClient {
    ...
    public static Retrofit newInstance() {
        OkHttpClient okHttpClient = new OkHttpClient.Builder()
                .addInterceptor(new reviewYelpRetrofitClient.HeaderInterceptor())
                .build();
        Log.d("review", "sendRequest");
